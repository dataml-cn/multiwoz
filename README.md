...
```bash
# create env
conda create -n multiwoz-env python=3.8
conda activate multiwoz-env

# cpu
conda install pytorch=1.10.1 torchvision torchaudio cpuonly -c pytorch

# gpu
conda install pytorch=1.10.1 torchvision torchaudio cudatoolkit=10.2 -c pytorch

# other
conda install nltk scipy tqdm simplejson 
